//B4SDP.h
  ...
  void updateMotorPositions(int *positions); // update array motor positions
  void printMotorPositions(int *positions); // print array of motor positions
  void restoreMotorPositions(int *positions); // restore array of motor positions
