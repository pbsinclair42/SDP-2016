...
def updatePositions():
    """Updates the system's belief of the state of the game based on the
    vision system"""
    ...
    # get the info on the ball from the vision system and update the system's
    # beliefs about the ball
    ...
    try:
        ...
        # otherwise if it's far enough from everything, it's free
        elif currentBallCoords is not None:
