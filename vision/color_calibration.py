...
def calibrateRanges():
    ...
    cv2.createTrackbar('H low red','red',h_low_init,180,nothing)
    cv2.createTrackbar('H high red','red',h_high_init,180,nothing)
    cv2.createTrackbar('S low red','red',s_low_init,255,nothing)
    cv2.createTrackbar('S high red','red',s_high_init,255,nothing)
    cv2.createTrackbar('V low red','red',v_low_init,255,nothing)
    cv2.createTrackbar('V high red','red',v_high_init,255,nothing)  

    cv2.createTrackbar('H low maroon','red',h_low_init,180,nothing)
    cv2.createTrackbar('H high maroon','red',h_high_init,180,nothing)
    cv2.createTrackbar('S low maroon','red',s_low_init,255,nothing)
    cv2.createTrackbar('S high maroon','red',s_high_init,255,nothing)
    cv2.createTrackbar('V low maroon','red',v_low_init,255,nothing)
